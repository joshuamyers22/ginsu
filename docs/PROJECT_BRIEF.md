...
| Publication posture | Build-only candidates remain enforced while trusted-publisher registrations, signed attestation, TestPyPI validation, and final candidate review are completed. The protected GitHub `pypi` and `testpypi` environments were inspected on 2026-09-13. | `docs/RELEASE_READINESS.md`; `docs/adr/0016-build-only-release-candidates.md`; `docs/adr/0017-trusted-publication-policy.md` |
